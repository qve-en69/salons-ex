<template>
  <div>
          <a-form-model>
            <FormGroup v-slot="attrs" :form="form" field="name" label="Название категории" show-custom-error>
              <a-input  
...
export default class ServiceCategoryCreateFormComponent extends Vue {
   @Prop() readonly form!: ServiceCategoryCreateForm;
}
</script>
